...
//enqueue test.php into customizer
require_once get_stylesheet_directory() . '/inc/theme-options/test.php';

//Get default of various fields with their ids
echo gutenbiz_get('test_font_size');