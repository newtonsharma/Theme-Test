	...
	Gutenbiz_Customizer::set(array(
		...
		'fields' => array(
			...
			array(
				...
				'label'   => esc_html__( 'Show Social Menu', 'gutenbiz' ),
				'description' => esc_html__( 'Please add Social menus for enabling Social menus. Go to Menus for setting up', 'gutenbiz' ),
				'default' => true,
				'type'    => 'toggle',
			)
		)
